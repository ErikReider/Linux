...
if [[ $vim_var = y ]]; then
    yay -S --needed scdoc
    yay -S --needed neovim-nightly-bin ccls texlive-bibtexextra texlive-gantt texlive-pictures vala-language-server-git the_silver_searcher bat ripgrep efm-langserver vint lua-format ueberzug digestif lua-language-server
